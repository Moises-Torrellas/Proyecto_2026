...
<body>
    ...
    <div class="header">
        <h1>REPORTE DE CATEGORÍAS DE CATÁLOGO</h1>
    ...
    <div class="content">
        ...
        <div class="resumen-ejecutivo">
            <strong>Resumen Ejecutivo:</strong> El presente documento contiene el registro detallado de las categorías del catálogo de inventario.
        </div>
            ...
            <tbody>
                <?php foreach ($datos as $r) : ?>
                    <tr>
                        ...
                        <td class="data-cell"><?= htmlspecialchars($r['descripcion']) ?></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
