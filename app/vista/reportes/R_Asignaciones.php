...
<head>
    ...
    <style>
        ...
        /* Clases para Asignaciones Anuladas/Devueltas */
        .fila-anulada {
            filter: grayscale(1);
            opacity: 0.6;
...
<body>
    ...
    <div class="content">
        ...
        <div class="resumen-ejecutivo">
            <strong>Resumen Ejecutivo:</strong> El presente documento detalla el registro de equipamiento deportivo asignado a los atletas del club. Incluye el estatus actual de cada pieza (en uso o devuelto/anulado) organizado por perfil de jugador.
        </div>
        ...
        <table class="data-table">
            ...
            <tbody>
                <?php
                $id = 0;
                // $datos es la variable que mandas desde el controlador (viene de ConsultarAsignaciones)
                foreach ($datos as $atleta) :
                    $id++;
                    
                    // Contar cuántos equipos activos tiene el atleta actualmente
                    $equiposActivos = 0;
                ...
                ?>
                    <tr>
                        ...
                        <td class="data-cell"><?= htmlspecialchars($atleta['doc_identidad']) ?></td>
                                ...
                                <table style="width: 100%; border-collapse: collapse; table-layout: fixed; word-wrap: break-word; font-size: 11px;">
                                    ...
                                    <tbody>
                                        <?php foreach ($atleta['asignaciones'] as $det) : 
                                            // Lógica de estado para tachar o no el equipo
                                            $esAnulado = ($det['anulado'] == 1 || $det['estatus'] == 0);
                                            $claseFila = $esAnulado ? 'fila-anulada' : '';
                                        ?>
                                            <tr class="<?= $claseFila ?>">
                                                <td style="padding: 4px 0; color: #4a5568; font-weight: bold;">
                                                    <?= htmlspecialchars($det['articulo']) ?>
                                                </td>
                                                ...
                                                <td class="no-strike" style="padding: 4px 0; text-align: right;">
                                                    <?= $esAnulado 
                                                        ? '<span style="color: #e53e3e; font-weight: bold;">Anulado</span>' 
    ...
    <div class="footer">
        ...
        <table class="footer-meta">
            <tr>
                <td class="text-left">Cannibals Lara - Reporte Automatizado de Asignaciones</td>
