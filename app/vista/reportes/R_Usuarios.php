...
<body>
    ...
    <div class="content">
        ...
        <div class="resumen-ejecutivo">
            <strong>Resumen Ejecutivo:</strong> El presente documento contiene el registro detallado de los usuarios registrados en el sistema.
        </div>
        ...
        <table class="data-table">
            ...
            <tbody>
                <?php foreach ($datos as $r) :
                    $estado = ($r['bloqueo'] == 1) ? 'Activo' : 'Bloqueado'; ?>
                    <tr>
                        <td class="data-cell"><?= htmlspecialchars($r['cedulaUsuario']) ?></td>
                        <td class="data-cell"><?= htmlspecialchars($r['nombreUsuario'] . ' ' . $r['apellidoUsuario']) ?></td>
                        <td class="data-cell"><?= htmlspecialchars($r['telefonoUsuario']) ?></td>
                        <td class="data-cell"><?= htmlspecialchars($r['correo']) ?></td>
                        <td class="data-cell"><?= htmlspecialchars($r['nombre_rol']) ?></td>
                        <td class="data-cell"><?= htmlspecialchars($estado) ?></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
