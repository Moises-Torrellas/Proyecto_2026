...
<body>
    ...
    <div class="content">
        ...
        <div class="resumen-ejecutivo">
            <strong>Resumen Ejecutivo:</strong> El presente documento detalla la información de los torneos registrados, especificando sus fechas, ubicaciones y su estado actual (Por Disputarse, En Curso, Finalizado).
        </div>

        <div class="section-title">Torneos Registrados</div>
            ...
            <tbody>
                ...
                if (!empty($datos)) {
                    foreach ($datos as $r): 
                        ...
                        $fecha_fin = date('d/m/Y', strtotime($r['fecha_fin']));
                        $ubicacion = htmlspecialchars($r['ubicacion']);
                        
                        $estatus = htmlspecialchars($r['estatus']);
                        $estatus_texto = '';
                        $color_estatus = '';
                        if ($estatus == 1) {
                ...
                ?>
                    <tr>
                        ...
                        <td class="data-cell"><?= $fecha_fin ?></td>
                        <td class="data-cell"><?= $ubicacion ?></td>
