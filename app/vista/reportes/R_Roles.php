...
<body>
    ...
    <div class="content">
        ...
        <div class="resumen-ejecutivo">
            <strong>Resumen Ejecutivo:</strong> El presente documento contiene el registro detallado de los roles del sistema.
        </div>
        ...
        <table class="data-table">
            ...
            <tbody>
                <?php foreach ($datos as $r) :
                    $descripcion = empty($r['descripcion']) ? 'Sin Descripción' : $r['descripcion']; ?>
                    <tr>
