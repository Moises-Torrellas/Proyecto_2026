    ...
    <section class="fondo_inicio">
        <div class="contenedor_inicio">
            ...
            <div class="contenedor_titulo_login">
                <h1 class="">¡Hola No Te Preocupes!</h1>
                <h2 class="">Podemos Recuperar tu Contraseña</h2>
            </div>
            <div class="separador">Recuperar Contraseña</div>
            ...
            <button type="button" class="btn btn_azul" onclick="window.location.href='/Proyecto_2026/public/Inicio'">Volver Al Inicio de Sesión</button>
        </div>
