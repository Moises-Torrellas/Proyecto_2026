            ...
            <div class="contenido_modulo">
                <div class="contenedor_funciones">
                    <div class="contenedor_opciones">
                        ...
                        <div class="botones">
                            <button class="btn btn_azul" id="incluir">Nuevo Devolucion</button>
                    ...
                    <div class="row">
                        <div class="colum">
                            <div class="caja_formulario">
                                ...
                                <label for="cuenta" class="titulo_formulario">Devoluciones</label>
                                <span class="mensaje" id="cuenta_span"></span>
                            </div>
                        </div>
                        <div class="colum">
                            <div class="caja_formulario">
                                <select name="asignaciones" id="asignaciones" class="formulario select">

                                </select>
                                <label for="asignaciones" class="titulo_formulario">Asignaciones</label>
                                <span class="mensaje" id="asignaciones_span"></span>
                            </div>
                        </div>
                    </div>
                    <div class="row">
