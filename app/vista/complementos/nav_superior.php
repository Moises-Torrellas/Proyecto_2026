    ...
    <div class="contenedor_superior">
        ...
        <div class="contenedor_usuario">
            ...
            <div class="info_usuario" id="info_usuario">
                <?php if (isset($_SESSION['foto']) && $_SESSION['foto'] !== 'default.png' && $_SESSION['foto'] !== '' && file_exists('img/usuarios/' . $_SESSION['foto'])) : ?>
            ...
            <div class="menu_superior ocultar" id="menu_superior">
                ...
                <ul class="nav_contenedor_superior">
                    <li class="nav_opciones nav_opciones_superior">
                        <a type="button" href="EditarPerfil" class="opciones"><i class="opciones_i" data-lucide="user-cog"></i> Mi Perfil</a>
