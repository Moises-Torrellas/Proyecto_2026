...
<div class=nav_superior>
    <div class="contenedor_superior">
        <div class="contenedor_logo">
            ...
            <h2 class="nombre_negocio">SIGMASELL</h2>
        </div>
        <div class="contenedor_usuario">
            <div class="botones_usuario">
                <a type="button" href="/Proyecto_2026/public/Principal" class="boton_usuario" id="casa" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Página Principal"><i class="fi-sr-house-chimney"></i></a>
                ...
                <a type="button" class="boton_usuario" id="modo_oscuro" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Tema de Color"><i class="fi <?php echo _TEMA_ === 'oscuro' ? 'fi-sr-sun' : 'fi-sr-moon' ?>"></i></a>
