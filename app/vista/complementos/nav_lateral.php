    ...
    <div class="navegacion" id="navegacion">
        <ul class="nav_contenedor">
            ...
            $puedeVer = function (int $id_modulo, string $clave_acceso) use ($nivelUsuario): bool {
                ...
                if ($nivelUsuario === 1 || $nivelUsuario === 2) return true;
            ...
            <?php if ($puedeVer(_MD_TORNEOS_, 'ingresar_torneos') || $puedeVer(_MD_EQUIPOS_, 'ingresar_equipo') || $puedeVer(_MD_PARTICIPACIONES_, 'ingresar_partici')) : ?>
                ...
                <li class="nav_opciones">
                    ...
                    <?php if ($puedeVer(_MD_EQUIPOS_, 'ingresar_equipo')) : ?>
                        <a type="button" href="Equipos" class="opciones"><i class="opciones_i" data-lucide="shield-half"></i> Equipos</a>
                    <?php endif; ?>

                    <?php if ($puedeVer(_MD_PARTICIPACIONES_, 'ingresar_partici')) : ?>
            ...
            <?php if ($puedeVer(_MD_PREMIOS_, 'ingresar_premio') || $puedeVer(_MD_PALMARES_, 'ingresar_palmares') || $puedeVer(_MD_ESTADISTICAS_, 'ingresar_estadistica')) : ?>
                ...
                <li class="nav_opciones">
                    ...
                    <?php if ($puedeVer(_MD_PALMARES_, 'ingresar_palmares')) : ?>
                        <a type="button" href="Palmares" class="opciones"><i class="opciones_i" data-lucide="podium"></i> Palmarés</a>
                    <?php endif; ?>

                    <?php if ($puedeVer(_MD_ESTADISTICAS_, 'ingresar_estadistica')) : ?>
