<div class="nav_lateral">
    <div class="navegacion" id="navegacion">
        <ul class="nav_contenedor">
            ...
            <a type="button" href="/Proyecto_2026/public/Principal" class="opciones">
            ...
            <?php if ($puedeVer(_MD_EQUIPAMIENTO_) || $puedeVer(_MD_CATALOGO_) || $puedeVer(_MD_CATEGORIA_EQUI_) || $puedeVer(_MD_CALIDAD_) || $puedeVer(_MD_ASIGNACIONES_) || $puedeVer(_MD_DEVOLUCIONES_)): ?>
                ...
                <li class="nav_opciones">
                    ...
                    <?php if ($puedeVer(_MD_CATALOGO_)): ?>
                        <a type="button" href="/Proyecto_2026/public/Catalogos" class="opciones"><i class="opciones_i" data-lucide="clipboard-pen-line"></i> Catalogo</a>
                    <?php endif; ?>
                    ...
                    <?php if ($puedeVer(_MD_DEVOLUCIONES_)): ?>
                        <a type="button" href="#" class="/Proyecto_2026/public/Devoluciones"><i class="opciones_i" data-lucide="list-restart"></i> Devoluciones</a>
                    <?php endif; ?>
                </li>
            <?php endif; ?>
