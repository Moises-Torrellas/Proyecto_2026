...
$(document).ready(function () {
    ...
    $('#proceso').on('click', function () {
        ...
        if (accion == "incluir") {
            ...
            if (validarEnvio(accion)) {
                confirmar('¿Está seguro que quiere modificar este equipos?', function (confirmado) {
                    if (confirmado) {
                        var datos = new FormData($('#f')[0]);
    ...
    $('#ayuda').on('click', function () {
        const pasos = [
            ...
            {
                element: '#incluir',
                popover: { title: 'Nuevo Representante', description: 'Si pulsa aqui se abrira un modal para ingresar un equipo', position: 'bottom' }
            },
            {
                element: '#generar',
            ...
            {
                element: '#cbt_v',
                popover: { title: 'Modificar Equipos', description: 'Si pulsa aqui se abrira un modal para modificar el Equipo seleccionado.', position: 'left' }
            },
            {
                element: '#cbt_r',
...
function eliminar(id) {
    confirmar('¿Está seguro que quiere eliminar este equipo?', function (confirmado) {
        if (confirmado) {
            var datos = new FormData();
...
function modificar(datos) {
    ...
    $("#proceso").text("Modificar Equipos");
    $("#titulo_modal").text("Modificar Equipos");
    $('#nombre').closest('.colum').show();
